const dataInfo = {
    ...
    "Iris": "This dataset contains a set of 150 records under 5 attributes - Sepal Length, Sepal width, Petal Length, Petal Width and its class. The dataset has been discretized to only work with two class labels and discrete values, instead of numerical ones."
}
