...
\imagen{sprint1_burndown}{Burndown Sprint 1}{1}
...
\imagen{sprint2_burndown}{Burndown Sprint 2}{1}
...
\imagen{sprint3_burndown}{Burndown Sprint 3}{1}
...
\imagen{sprint4_burndown}{Burndown Sprint 4}{1}
...
\imagen{sprint5_burndown}{Burndown Sprint 5}{1}
...
\imagen{sprint6_burndown}{Burndown Sprint 6}{1}
...
\tablaSmallSinColores{Every dataset used in the project as an example dataset and its license}{l c c}{table_dataset_licenses}
{ \multicolumn{1}{l}{Dataset} & License \\}{ 
